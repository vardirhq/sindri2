...
- [ ] Add a sprite sheet authoring surface: slice a sheet into frames, name clips, set timing, preview playback — the format exists now, which is the half Milestone 6 says comes first; what is missing is the surface
