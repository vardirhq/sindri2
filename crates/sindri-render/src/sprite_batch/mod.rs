//! Drawing sprites in as few passes as the ordering allows.
...
pub use instance::{SpriteDepth, SpriteInstance};
pub use stats::SpriteBatchStats;

use instance::BatchUniform;
