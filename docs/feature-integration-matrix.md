...
| Decay scripts and exports | **Ready** — typed host, compile/run/reload, safe entity references | **Partial** — component and `@export` fields; source cannot be created or edited | **Partial** — useful gameplay subset; no collections, LSP, formatter, or debugger | **Ready** — all gameplay rules are Decay | Host manifest, typed schema access, and source tooling |
