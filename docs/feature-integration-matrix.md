...
| Pathfinding and occupancy | **Partial** — deterministic renderer-free A* and whole-footprint occupancy paths exist; no wall edges or world adapter | **Missing** | **Missing** | **Missing** | Add wall edges and engine/editor adapters, then typed Decay access and a Gather use case |
