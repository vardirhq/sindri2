...
/// The volume picking the engine owns, named here because this is where the
/// editor's pointer work looks for it.
pub use sindri_scene::voxel::{model_of, ray_at_viewport};
