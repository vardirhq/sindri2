...
//! engine, and `textures/badge.png` is a real file sitting beside the scene,
//! loaded from there like any other project's. A reference that resolved to
//! neither would still draw, as the missing-texture checker; that is a property
//! worth having and a poor thing to open the editor into, so a test holds the
//! fixture to naming only textures that resolve.
